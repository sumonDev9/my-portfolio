...
const Banner = () => {
    return (
    <div name="home" className=" pt-20 relative overflow-hidden bg-cover" 
    >
      <div className=" container gap-4 mx-auto flex flex-col-reverse md:flex-row items-center justify-between">
        ...
        <div className=" md:w-5/12">
          {/* <img
            className="  text-primary-color w-[300px] h-[300px] "
            src="https://i.ibb.co/9Zw5qn0/logomitra.jpg"
            alt=""
          /> */}
          <img
            className=" drop-shadow-md rounded-full w-full "
